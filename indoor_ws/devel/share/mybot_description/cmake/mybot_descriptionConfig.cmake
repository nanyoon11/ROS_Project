...
if("TRUE" STREQUAL "TRUE")
  set(mybot_description_SOURCE_PREFIX /home/nanyoon/indoor_ws/src/mybot_description)
  set(mybot_description_DEVEL_PREFIX /home/nanyoon/indoor_ws/devel)
  ...
  set(mybot_description_INSTALL_PREFIX /home/nanyoon/indoor_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'isgm248 <isgm248@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mybot_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nanyoon/indoor_ws/src/mybot_description/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT mybot_description_NUM_DUMMY_TARGETS)
      set(mybot_description_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::mybot_description::wrapped-linker-option${mybot_description_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR mybot_description_NUM_DUMMY_TARGETS "${mybot_description_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::mybot_description::wrapped-linker-option${mybot_description_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND mybot_description_LIBRARIES "${interface_target_name}")
